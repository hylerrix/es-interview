...
export default {
    ...
    'outputPath': "articles/00-Beginner/02-es-rank.html",
    'title': "大厂职级",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h1>大厂职级</h1>\n<h2 id="bat">BAT<a class="anchor" href="#bat">§</a></h2>\n<h2 id="tmd">TMD<a class="anchor" href="#tmd">§</a></h2>\n<h2 id="">...<a class="anchor" href="#">§</a></h2>\n<blockquote>\n<p>期待你的补充。</p>\n</blockquote>'
        } }),
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5927\u5382\u804C\u7EA7"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h2 id="bat">BAT<a class="anchor" href="#bat">§</a></h2>\n<h2 id="tmd">TMD<a class="anchor" href="#tmd">§</a></h2>\n<h2 id="">...<a class="anchor" href="#">§</a></h2>\n<blockquote>\n<p>期待你的补充。</p>\n</blockquote>'
        } }),
    'contentHasKatex': false,
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#bat">BAT</a></li><li><a href="#tmd">TMD</a></li><li><a href="#">...</a></li></ol></nav>'
        } }),
