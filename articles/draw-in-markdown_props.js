...
export default {
    ...
    'outputPath': "articles/draw-in-markdown.html",
    'title': "如何用 Markdown 绘制图片",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h1>如何用 Markdown 绘制图片</h1>\n<blockquote>\n<p>《ECMAScript+ 面试宝典》决定全量使用“无插图”化文档，对于有图片需求的地方可以使用 markdown 的绘图插件功能支持。\n这样做的好处是：</p>\n<ul>\n<li>节省大量图片流量。</li>\n<li>确保每一张图都是用代码的形式认真绘制而出，而非简单的外网复制粘贴。</li>\n</ul>\n<p>因此，如何使用 Markdown 绘制图片的笔记就先放在《ECMAScript+ 面试宝典》中，以供随时参考。</p>\n</blockquote>\n<p>...学习 &amp; 完善中。</p>'
        } }),
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u5982\u4F55\u7528 Markdown \u7ED8\u5236\u56FE\u7247"),
